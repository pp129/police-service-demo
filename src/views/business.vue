<template>
    <div class="business">
        <div class="text">
            以大数据为核心，全方位、多角度透彻感知人、车、船、地、物、案或
            事件等要素动态，汇聚各类数据资源，利用大数据挖掘、融合、分析技术，
            形成“广泛采集、辅助决策、研判分析、信息融合”的工作格局，打造“全
            新警务工作模式”，全面实现警务工作智能化。
        </div>
        <div class="pic">
...
.business {
    ...
    .pic {
        background: url("../assets/business_content_base.png") no-repeat;
        background-size: contain;
        height: calc(~"593*@{ph}vh");
        width: calc(~"1033*@{pw}vw");
        position: absolute;
        ...
        .ui_base {
            ...
            .base {
                ...
                .ball_base {
                    ...
                    &.ball_2 {
                        -webkit-transform: rotateX(-90deg) rotateY(60deg)
                            translateY(-70px);
                        -moz-transform: rotateX(-90deg) rotateY(60deg)
                            translateY(-70px);
                        -o-transform: rotateX(-90deg) rotateY(60deg)
                            translateY(-70px);
                        -ms-transform: rotateX(-90deg) rotateY(60deg)
                            translateY(-70px);
                    ...
                    &.ball_3 {
                        -webkit-transform: rotateX(-90deg) rotateY(120deg)
                            translateY(-70px);
                        -o-transform: rotateX(-90deg) rotateY(120deg)
                            translateY(-70px);
                        -ms-transform: rotateX(-90deg) rotateY(120deg)
                            translateY(-70px);
                        -moz-transform: rotateX(-90deg) rotateY(120deg)
                            translateY(-70px);
